...
def calc_hvac_savings_simple(electricity_kwh_year, delta_t_c,
                             energy_sensitivity_per_c, beta,
                             grid_factor_kg_per_kwh=0.43,
                             carbon_price_eur_per_ton=85.0):
...
def calc_water_savings(water_baseline_m3_year, water_actual_m3_year,
                       pump_kwh_per_m3,
                       grid_factor_kg_per_kwh=0.43,
                       carbon_price_eur_per_ton=85.0):
